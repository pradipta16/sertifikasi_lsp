                ...
                <form action="/peserta/update/{{ $peserta->nik }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-5">
                            ...
                            <input type="file" class="form-control" name="foto" value="{{ $peserta->foto }}">
                            <div class="text-danger">
                                @error('foto')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-7">
                            ...
                            <input type="date" name="tgl_lahir" class="form-control" value="{{ $peserta->tgl_lahir }}">
                            <div class="text-danger">
                                @error('tgl_lahir')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-7">
                            ...
                            <input type="textarea" class="form-control" name="alamat" value="{{ $peserta->alamat }}">
                            <div class="text-danger">
                                @error('alamat')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-7">
                            ...
                            <input type="text" name="nohp" class="form-control" value="{{ $peserta->nohp }}">
                            <div class="text-danger">
                                @error('nohp')
                                    {{ $message }}
                                @enderror
